...
In the industry, you should not implement your own authentication system and use a module or framework that doing it for you (like in Python-Flask: Flask-User{https://intranet.alxswe.com/rltoken/9nVfotMI_1zpEzihMzBeTA} https://flask-user.readthedocs.io/en/latest/). Here, for the learning purpose, we will walk through each step of this mechanism to understand it by doing.

Resources
Read or watch:

Flask documentation {https://intranet.alxswe.com/rltoken/lKExyvivrrW4eh0eI8UV6A} https://flask.palletsprojects.com/en/2.1.x/quickstart/

Requests module {https://intranet.alxswe.com/rltoken/py7LuuD1u2MUwcaf8wnDzQ} https://requests.kennethreitz.org/en/latest/user/quickstart/

HTTP status codes {https://intranet.alxswe.com/rltoken/cj-mc5ZHp_KyXn1yikHC0A} https://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html
